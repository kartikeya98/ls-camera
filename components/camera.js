...
import {  Camera,  Permissions, BarCodeScanner ,MediaLibrary , Location} from 'expo';
...
export default class CameraScreen extends React.Component {
  ...
  onPictureSaved = async photo => {
    ...
    if(album === null) {
      ...
      console.log('asset',promises)
        await MediaLibrary.createAlbumAsync('lsCamera',promises,true)
